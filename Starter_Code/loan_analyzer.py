...
total_of_value_loans = sum(loan_costs)
print(f'The total value of loans is: ${total_of_value_loans}')

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
average_amount_of_loans = total_of_value_loans / number_of_loans
print(f'The average loan amount is: ${average_amount_of_loans}')
...
for items in loans:
    if items["loan_price"] <= 500:
        inexpensive_loans.append(items)
